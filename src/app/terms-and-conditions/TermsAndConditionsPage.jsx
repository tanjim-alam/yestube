        ...
        <div className='bg-white lg:py-20 py-10'>
            <div className='lg:w-[80%] w-[90%] m-auto'>
                <div className='flex flex-col gap-6'>
                    ...
                    <p className='leading-relaxed text-slate-600'>
                        These terms and conditions outline the rules and regulations for the use of YesTube Media’s Website, located at www.YesTube.co.
                    </p>
                    <p className='leading-relaxed text-slate-600'>
                        By accessing this website we assume you accept these terms and conditions. Do not continue to use YesTube if you do not agree to take all of the terms and conditions stated on this page.
                    </p>
                    <p className='leading-relaxed text-slate-600'>
                ...
                <div className='mt-6 flex flex-col gap-6'>
                    <div className='flex flex-col gap-6'>
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            We employ the use of cookies. By accessing YesTube, you agreed to use cookies in agreement with the YesTube Media’s Privacy Policy.
                        </p>
                        <p className='leading-relaxed text-slate-600'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            Unless otherwise stated, YesTube Media and/or its licensors own the intellectual property rights for all material
                            on YesTube. All intellectual property rights are reserved. You may access this from YesTube for your own personal
                        ...
                        <ul className='flex flex-col gap-3 list-disc list-inside leading-relaxed text-slate-600'>
                            <li >
                                Republish material from YesTube
                            </li>
                            <li>
                                Sell, rent or sub-license material from YesTube
                            </li>
                            <li>
                                Reproduce, duplicate or copy material from YesTube
                            </li>
                            <li>
                                Redistribute content from YesTube
                            </li>
                        </ul>
                        <p className='leading-relaxed text-slate-600'>
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            ...
                            of the website. YesTube Media does not filter, edit, publish or review Comments prior to their presence on the website.
                            Comments do not reflect the views and opinions of YesTube Media,its agents and/or affiliates. Comments reflect the
                            views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws,
                            YesTube Media shall not be liable for the Comments or for any liability, damages or expenses caused and/or
                            suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                        </p>
                        <p className='leading-relaxed text-slate-600'>
                            YesTube Media reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
                        </p>
                        <p className='leading-relaxed text-slate-600'>
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            You hereby grant YesTube Media a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
                        </p>
                    </div>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            ...
                            the benefit to us from the visibility of the hyperlink compensates the absence of YesTube Media; and (d) the link
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            ...
                            you must inform us by sending an e-mail to YesTube Media. Please include your name, your organization name,
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            No use of YesTube Media’s logo or other artwork will be allowed for linking absent a trademark license agreement.
                        </p>
                    </div>
                    <div className='mt-6 flex flex-col gap-6'>
