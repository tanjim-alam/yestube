...
function IgReelsDownloaderPage() {
    ...
    const handleDownload = async (e) => {
        ...
        //     setError('Invalid URL format. Please enter a valid Instagram Reel URL.');
        //     return;
        // }
        ...
        <div className='w-full bg-white py-16'>
            <div className='lg:w-[80%] md:w-[80%] w-[95%] m-auto'>
                <div className='lg:w-[80%] m-auto'>
                    <h1 className='text-3xl font-semibold text-black text-center'>Instagram Reels Downloader</h1>
                    <p className='mt-6 leading-normal text-[18px] text-center text-neutral-800'>
                        YesTube.xyz is an online free and fast tool which helps you to download instagram reels video or to save reels video to your device. You can save any reels
